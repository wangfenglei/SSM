                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/permission/findPermissionMany.do?id=${permission.id}'">
                        ...
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table"
                                ...
                                <c:forEach items="${permission.roles}" var="role" varStatus="vs1">
                                    ...
                                    <c:forEach items="${role.users}" var="p">
