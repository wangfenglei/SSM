	...
	<div class="wrapper">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.pageNum}&size=${pageInfo.pageSize}'">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="p">
										<tr>
											<td><input name="test" type="checkbox" value="${p.id}"></td>
											<td>${p.id }</td>
											<td>${p.permissionName }</td>
											<td>${p.url }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/findPermissionMany.do?id=${p.id}" class="btn bg-olive btn-xs">详情</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<script>
            ...
            function deletePro(){
                ...
                //alert(check_val);
                location.href="${pageContext.request.contextPath}/permission/deletePermission.do?id="+check_val;
            }
