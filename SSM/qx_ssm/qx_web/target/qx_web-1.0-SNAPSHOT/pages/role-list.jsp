	...
	<div class="wrapper">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/role/findAll.do?page=${pageInfo.pageNum}&size=${pageInfo.pageSize}'">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
                                            <td><input class="ck" name="test" type="checkbox" value="${role.id }"></td>
											<td>${role.id }</td>
											<td>${role.roleName }</td>
											<td>${role.roleDesc }</td>																				
		...
		<script>
            ...
            function deletePro(){
                ...
                //alert(check_val);
                location.href="${pageContext.request.contextPath}/role/deleteRole.do?id="+check_val;
            }
