...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/role/save.do" name="news" id="myForm" onsubmit="return myCheck()"
				method="post">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title" id="roleName">角色名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="roleName"
								placeholder="角色名称" value="">
						</div>
						<div class="col-md-2 title" id="roleDesc">角色描述</div>
						<div class="col-md-4 data">
	...
	<script>
        ...
        function myCheck(){
            for(var i=0;i<document.news.elements.length-2;i++)
            {
