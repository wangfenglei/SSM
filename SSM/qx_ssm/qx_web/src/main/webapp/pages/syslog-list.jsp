...
<body class="hold-transition skin-blue sidebar-mini">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="刷新"
										onclick="location.href='${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum}&size=${pageInfo.pageSize}'">
										<i class="fa fa-refresh"></i> 刷新
									</button>

                                    <button type="button" class="btn btn-default" title="删除" onclick="deleteLog()"><i
	...
	<script>
        ...
        function deleteLog(){
            ...
            location.href="${pageContext.request.contextPath}/sysLog/delLog.do?id=";
        }
