...
<div class="music-lgin">
    ...
    <div class="music-lgin-all">
        ...
        <div class="music-lgin-dh">
            ...
            <!--消息框-->
            <div class="music-news" ><strong>您的权限不足!</strong>,老弟！</div>
        </div>
    ...
    <div class="music-lgin-text">
        <input class="inputname inputs" type="hidden" placeholder="用户名" value="admin">
    </div>
    <!--2-->
    <div class="music-lgin-text">
        <input type="hidden" class="mima inputs" placeholder="密码" />
    </div>
    <!--3-->
    <div class="music-lgin-text">

        <input class="music-qd inputs" type="button" value=" 返回" onclick="history.back(-1);"/>
